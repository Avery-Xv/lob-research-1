...
NP01–NP05 继续读取已有 非母单订单状态 缓存，不在这里重读原始 LOB。第一版不读取
...
```bash
conda_lob/bin/python scripts/factors/shared_lob_primitives/run.py \
  ...
  --shard-dir data/cache/shared_lob_primitives/intraday_1000_1030_202601_202602_v1
```
