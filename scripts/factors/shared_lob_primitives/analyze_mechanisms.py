#!/usr/bin/env python3
"""Aggregate first-layer mechanism evidence from shared_lob_primitives.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--shard-root",
        type=Path,
        default=PROJECT_ROOT / "data/cache/shared_lob_primitives/intraday_1000_1030_202601_202602_v1",
    )
    parser.add_argument(
        "--cache-dir",
        type=Path,
        default=PROJECT_ROOT / "data/cache/shared_lob_primitives/mechanism_analysis_202601_202602_v1",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "results/intraday/shared_lob_primitives/mechanism_analysis_202601_202602_v1",
    )
...
def main() -> int:
    ...
    try:
        ...
        metadata = {
            "analysis": "shared_lob_primitives first-layer mechanisms",
            "analysis_version": "shared_lob_primitives_first_layer_v2_20260807",
